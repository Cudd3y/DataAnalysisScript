...
data <- data %>%
  ...
  select (Participant, Condition, TrialNumber, Block, TargetNumber, Block_start, Block_end, TargetIsHit, TargetHighlighted, TargetClicked, PosX, PosY, Distance, Repetition)
...
## Exploratory plot
Plotting the relationship between MovementTime and Regular Edge Trials.
```{r}
p_time <- 
...
p_time
```
Plotting the relationship between MovementTime and Virtual Edge Trials.
```{r}
p_time1 <- 
...
```
From QQ-plot, we see that the residuals are not normally distributed.
